...
local keys = {
  ...
  { "Horizontal bottom split", "<leader>ws", function() helix.split_current_view("horizontal") end },
  { "Vertical right split", "<leader>wv", function() helix.split_current_view("vertical") end },
  ...
  { "Goto next window", "<C-w><C-w>", "<C-w>w" },
  { "Horizontal bottom split", "<C-w>s", function() helix.split_current_view("horizontal") end },
  { "Horizontal bottom split", "<C-w><C-s>", function() helix.split_current_view("horizontal") end },
  { "Vertical right split", "<C-w>v", function() helix.split_current_view("vertical") end },
  { "Vertical right split", "<C-w><C-v>", function() helix.split_current_view("vertical") end },
  { "Transpose splits", "<C-w>t", helix.transpose_splits },
  { "Transpose splits", "<C-w><C-t>", helix.transpose_splits },
  ...
  { "Close window", "<C-w><C-q>", "<cmd>close<CR>" },
  { "Close windows except current", "<C-w>o", "<cmd>only<CR>" },
  { "Close windows except current", "<C-w><C-o>", "<cmd>only<CR>" },
  { "Jump to left split", "<C-w>h", "<C-w>h" },
  { "Jump to left split", "<C-w><C-h>", "<C-w>h" },
  { "Jump to left split", "<C-w><Left>", "<C-w>h" },
  { "Jump to split below", "<C-w>j", "<C-w>j" },
  { "Jump to split below", "<C-w><C-j>", "<C-w>j" },
  { "Jump to split below", "<C-w><Down>", "<C-w>j" },
  { "Jump to split above", "<C-w>k", "<C-w>k" },
  { "Jump to split above", "<C-w><C-k>", "<C-w>k" },
  { "Jump to split above", "<C-w><Up>", "<C-w>k" },
  { "Jump to right split", "<C-w>l", "<C-w>l" },
  { "Jump to right split", "<C-w><C-l>", "<C-w>l" },
  { "Jump to right split", "<C-w><Right>", "<C-w>l" },
  ...
  { "Horizontal bottom split scratch buffer", "<C-w>n<C-s>", function() helix.new_scratch_split("horizontal") end },
  { "Vertical right split scratch buffer", "<C-w>nv", function() helix.new_scratch_split("vertical") end },
  { "Vertical right split scratch buffer", "<C-w>n<C-v>", function() helix.new_scratch_split("vertical") end },
  ...
  { "Page up", "<C-b>", function() helix.scroll_page(-1) end },
  { "Page down", "<C-f>", function() helix.scroll_page(1) end },
  { "Page up", "<PageUp>", function() helix.scroll_page(-1) end },
  { "Page down", "<PageDown>", function() helix.scroll_page(1) end },
  ...
  { "Left", "<Left>", helix.normal_motion("h") },
  { "Down", "j", helix.move_visual_line_down },
  { "Down", "<Down>", helix.move_visual_line_down },
  { "Up", "k", helix.move_visual_line_up },
  { "Up", "<Up>", helix.move_visual_line_up },
  { "Right", "l", helix.normal_motion("l") },
  { "Right", "<Right>", helix.normal_motion("l") },
  { "Goto line start", "<Home>", helix.goto_line_start },
  { "Goto line end", "<End>", helix.goto_line_end },
  ...
  { "Lowercase selections", "`", function() helix.set_selection_case("lower") end },
  { "Uppercase selections", "<A-`>", function() helix.set_selection_case("upper") end },

  { "Extend line below", "x", helix.extend_line_below },
  { "Extend selections to line bounds", "X", helix.extend_to_line_bounds },
  { "Shrink selections to line bounds", "<A-x>", helix.shrink_to_line_bounds },
  ...
  { "Split selections by regex", "S", helix.split_selection_by_regex },
  { "Split selection by line", "<A-s>", helix.split_selection_by_line },
  { "Merge overlapping selections", "<A-->", function() helix.merge_selections(false) end },
  { "Merge consecutive selections", "<A-_>", function() helix.merge_selections(true) end },
  ...
  { "Remove primary selection", "<A-,>", helix.remove_primary_selection },
  ...
  { "Join selected lines", "J", function() helix.join_selections(false) end },
  { "Join selected lines and select spaces", "<A-J>", function() helix.join_selections(true) end },
  { "Expand syntax selection", "<A-o>", helix.expand_selection },
  { "Expand syntax selection", "<A-Up>", helix.expand_selection },
  { "Shrink syntax selection", "<A-i>", helix.shrink_selection },
  { "Shrink syntax selection", "<A-Down>", helix.shrink_selection },
  { "Select all syntax children", "<A-I>", helix.select_all_treesitter_children },
  { "Select all syntax children", "<A-S-Down>", helix.select_all_treesitter_children },
  { "Select previous syntax sibling", "<A-p>", function() helix.select_treesitter_sibling("backward") end },
  { "Select previous syntax sibling", "<A-Left>", function() helix.select_treesitter_sibling("backward") end },
  { "Select next syntax sibling", "<A-n>", function() helix.select_treesitter_sibling("forward") end },
  { "Select next syntax sibling", "<A-Right>", function() helix.select_treesitter_sibling("forward") end },
  { "Move to parent node end", "<A-e>", function() helix.move_parent_node_boundary("end") end },
  { "Move to parent node start", "<A-b>", function() helix.move_parent_node_boundary("start") end },
  { "Select all syntax siblings", "<A-a>", helix.select_all_treesitter_siblings },
  ...
  { "Undo", "u", helix.undo },
  { "Redo", "U", helix.redo },
  { "Earlier history", "<A-u>", helix.earlier },
  { "Later history", "<A-U>", helix.later },
